...
\usepackage{fontspec}
% Use Latin Modern as a fallback - it's always available and reliable
\setmainfont{Latin Modern Roman}[
    Ligatures=TeX
]
% Alternative: If you want Times-like font, use:
% \setmainfont{TeX Gyre Termes}[Ligatures=TeX]

% Remove inputenc and fontenc for XeLaTeX - they are not needed and cause conflicts
