...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\columnwidth]{architecture_diagram.png}
\caption{Dual-encoder Siamese network architecture showing query and passage encoding through shared MiniLM transformer, followed by cosine similarity computation for relevance scoring.}
