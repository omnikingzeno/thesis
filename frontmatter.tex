\frontmatter% Use roman page numbering style (i, ii, iii, iv...) for the pre-cont\begin{spacing}{1.5}
...
\begin{flushright}
    \begin{minipage}{0.5\textwidth}
        ...
        \makebox[6cm]{\textbf{Manu Pande - MML2023005}} \\[80pt]declare that work presented in the report entitled "\textbf{When Fine-Tuning Fails: Lessons from MS MARCO Passage Ranking}", submitted towards the fulfillment of MASTER'S THESIS report of M.Tech at Indian Institute of Information Technology Allahabad, is an authenticated original work carried out under supervision of \textbf{Dr. Muneendra Ojha}. Due Acknowledgements have been made in the text to all other material used. the project was done in full compliance with the requirements and constraints of the prescribed curriculum.pages
...
\begin{flushright}
    \begin{minipage}{0.5\textwidth}
        \flushright \vspace{60 pt}
        \underline{\hspace{6cm}} \\
        \makebox[6cm]{\textbf{Koneti Revanth Kumar - MMI2023011}} \\[80pt]
    \end{minipage}
\end{flushright}
\end{spacing}
\newpage
