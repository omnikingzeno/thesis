...
\caption{Dual-encoder Siamese network architecture employed by the sentence-transformers/all-MiniLM-L6-v2 model. The architecture shows parallel encoding of queries and passages through shared MiniLM transformer layers, followed by cosine similarity computation for relevance scoring. This symmetric design enables efficient pre-computation of passage embeddings for large-scale retrieval.}
